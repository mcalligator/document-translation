...
export class DocTranStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const serverAccessLoggingBucket = new s3.Bucket(this, "serverAccessLoggingBucket", {
    ...
    NagSuppressions.addResourceSuppressions(
      ...
      [
        {
          id: "AwsSolutions-S1",
          reason: "This bucket is the AccessLogs destination bucket for other buckets.",
        },
      ],
      true,
    );
    ...
    this.awsUserPoolsWebClientId = new cdk.CfnOutput(this, "awsUserPoolsWebClientId", {
    ...
    this.awsCognitoOauthDomain = new cdk.CfnOutput(this, "awsCognitoOauthDomain", {
      value: base_api.userPoolDomain.domainName,
    });
    this.awsCognitoIdentityPoolId = new cdk.CfnOutput(this, "awsCognitoIdentityPoolId", {
    ...
    this.awsAppsyncGraphqlEndpoint = new cdk.CfnOutput(this, "awsAppsyncGraphqlEndpoint", {
    ...
    if (translation) {
      ...
      // OUTPUTS
      this.awsUserFilesS3Bucket = new cdk.CfnOutput(this, "awsUserFilesS3Bucket", {
    ...
    if (readable) {
      ...
      // OUTPUTS
      this.awsReadableS3Bucket = new cdk.CfnOutput(this, "awsReadableS3Bucket", {
    ...
    if (webUi) {
      ...
      this.appWebsiteDistribution = new cdk.CfnOutput(this, "appWebsiteDistribution", {
