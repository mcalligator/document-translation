...
import { aws_lambda as lambda, aws_iam as iam, aws_lambda_nodejs as nodejs } from "aws-cdk-lib";
...
export class dt_lambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: props) {
    ...
    const runtime: lambda.Runtime =
      props.runtime !== undefined ? props.runtime : lambda.Runtime.NODEJS_20_X; // ASM-L1

    const architecture: lambda.Architecture =
      props.architecture !== undefined ? props.architecture : lambda.Architecture.ARM_64;

    const lambdaLogicalId = "BaseFunction";
    ...
    this.lambdaFunction = new nodejs.NodejsFunction(this, lambdaLogicalId, {
      ...
      logGroup: props.functionName ? logGroup : undefined,
    ...
    const iamPolicyPermitLogging = new iam.Policy(this, "iamPolicyPermitLogging", {
